...
Cloud Build is used to run tests against Google Cloud resources in test project: langchain-datastore-testing.
...
1. Create an datastore cluster, instance, and database
